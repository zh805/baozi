...
class Ui_Dialog_add(object):
    def setupUi(self, Dialog_add):
        ...
        self.label_8.setGeometry(QtCore.QRect(120, 460, 91, 21))
        font = QtGui.QFont()
        ...
        self.label_9.setGeometry(QtCore.QRect(110, 310, 661, 16))
        self.label_9.setObjectName("label_9")
        self.reset_bd = QtWidgets.QPushButton(Dialog_add)
        self.reset_bd.setGeometry(QtCore.QRect(570, 80, 93, 31))
        self.reset_bd.setObjectName("reset_bd")
        self.toolButton = QtWidgets.QToolButton(Dialog_add)
        self.toolButton.setGeometry(QtCore.QRect(590, 390, 47, 31))
        self.toolButton.setObjectName("toolButton")
        self.label_4 = QtWidgets.QLabel(Dialog_add)
        self.label_4.setGeometry(QtCore.QRect(290, 220, 60, 28))
        self.label_4.setObjectName("label_4")
        self.label = QtWidgets.QLabel(Dialog_add)
        self.label.setGeometry(QtCore.QRect(200, 40, 371, 101))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.label_2.setGeometry(QtCore.QRect(120, 180, 121, 27))
        font = QtGui.QFont()
        font.setFamily("楷体")
        ...
        self.label_6.setGeometry(QtCore.QRect(120, 340, 141, 31))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(16)
        ...
        self.toolButton_3.setGeometry(QtCore.QRect(650, 390, 47, 31))
        self.toolButton_3.setObjectName("toolButton_3")
        self.lineEdit_3 = QtWidgets.QLineEdit(Dialog_add)
        self.lineEdit_3.setGeometry(QtCore.QRect(210, 370, 361, 31))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.layoutWidget = QtWidgets.QWidget(Dialog_add)
        self.layoutWidget.setGeometry(QtCore.QRect(120, 250, 531, 30))
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(210, 460, 361, 31))
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.toolButton_2 = QtWidgets.QToolButton(Dialog_add)
        self.toolButton_2.setGeometry(QtCore.QRect(590, 460, 47, 31))
        self.toolButton_2.setObjectName("toolButton_2")
        self.toolButton_4 = QtWidgets.QToolButton(Dialog_add)
        self.toolButton_4.setGeometry(QtCore.QRect(650, 460, 47, 31))
        self.toolButton_4.setObjectName("toolButton_4")
        self.comboBox = QtWidgets.QComboBox(Dialog_add)
        self.comboBox.setGeometry(QtCore.QRect(240, 180, 311, 21))
        self.comboBox.setObjectName("comboBox")
        self.label_5 = QtWidgets.QLabel(Dialog_add)
        self.label_5.setGeometry(QtCore.QRect(440, 220, 60, 28))
        self.label_5.setObjectName("label_5")
        self.label_7 = QtWidgets.QLabel(Dialog_add)
        self.label_7.setGeometry(QtCore.QRect(120, 390, 91, 21))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
